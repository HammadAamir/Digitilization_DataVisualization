      ...
      <div className="max-w-screen-xl mx-auto px-5 flex justify-between items-center">
        <div className="flex space-x-12">
          <div className="flex flex-col items-start">
            ...
            <span className="text-sm text-[#b0b0b0] uppercase tracking-wider">Chart Types</span>
          </div>
          <div className="flex flex-col items-start">
            <span className="text-3xl font-bold text-white mb-1">30+</span>
            <span className="text-sm text-[#b0b0b0] uppercase tracking-wider">Countries</span>
          </div>
          <div className="flex flex-col items-start">
            <span className="text-3xl font-bold text-white mb-1">5</span>
            <span className="text-sm text-[#b0b0b0] uppercase tracking-wider">Datasets</span>
          </div>
        </div>
        <div className="flex items-center space-x-2 cursor-pointer transition-colors duration-300 hover:text-white">
